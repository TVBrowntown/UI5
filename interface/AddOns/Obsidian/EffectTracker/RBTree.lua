Obsidian.RBTree = {};
Obsidian.RBTree.__index = Obsidian.RBTree;
...
function Obsidian.RBTree:Create(comparer)
...
function Obsidian.RBTree:Insert(value)
...
function Obsidian.RBTree:InsertRecolor(node)
...
function Obsidian.RBTree:RotateLeft(node)
...
function Obsidian.RBTree:RotateRight(node)
...
function Obsidian.RBTree:Remove(node)
...
function Obsidian.RBTree:RemoveRecolor(node)
...
function Obsidian.RBTree:Clear()
...
function Obsidian.RBTree:GetValues(maximumCount)
