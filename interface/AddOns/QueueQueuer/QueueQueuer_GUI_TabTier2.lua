...
QueueQueuer_GUI_TabTier2 = {}

function QueueQueuer_GUI_TabTier2.OnInitialize()
	LabelSetText( "QueueQueuer_GUI_TabTier2_BlacklistTier2Title", L"Tier 2 Blacklist" )
end

function QueueQueuer_GUI_TabTier2.OnShutdown()
end
