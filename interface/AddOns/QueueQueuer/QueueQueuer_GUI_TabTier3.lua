...
QueueQueuer_GUI_TabTier3 = {}

function QueueQueuer_GUI_TabTier3.OnInitialize()
	LabelSetText( "QueueQueuer_GUI_TabTier3_BlacklistTier3Title", L"Tier 3 Blacklist" )
end

function QueueQueuer_GUI_TabTier3.OnShutdown()
end
