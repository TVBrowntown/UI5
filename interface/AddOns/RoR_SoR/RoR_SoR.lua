...
if DoesWindowExist("RoR_SoR_Popper") then WindowSetScale("RoR_SoR_Popper", RoR_Window_Scale) end
...
function RoR_SoR.GetPairing(zone)
...
function  RoR_SoR.Restack()
	...
	if RoR_SoR.Settings.Enabled then
		if DoesWindowExist("RoR_SoR_ButtonBtn") then WindowSetTintColor("RoR_SoR_ButtonBtn",255,255,255) end
	else
		if DoesWindowExist("RoR_SoR_ButtonBtn") then WindowSetTintColor("RoR_SoR_ButtonBtn",125,125,125) end
	end	
...
function RoR_SoR.SET_BO(Input)
	...
	if DoesWindowExist("SoR_"..Window_Name) then
		...
		DynamicImageSetTextureSlice("SoR_"..Window_Name.."BG", RoR_SoR.ParingPortrait[RoR_SoR.GetPairing(Window_Name)])
		RoR_SoR.ZoneTimer[Window_Name] = ZoneLockTimer
